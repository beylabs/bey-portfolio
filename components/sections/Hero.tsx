      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Senior administration and HR professional who personally designs, builds, and deploys
            the production systems government and education institutions depend on.
          </p>
