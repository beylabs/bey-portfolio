...
export default function Hero() {
  return (
    <section className=\"relative min-h-screen flex items-center justify-center overflow-hidden bg-midnight text-white\">
      ...
      <div className=\"container mx-auto px-6 relative z-10 text-center\">
        ...
        >
          ...
          <div className=\"flex flex-col sm:flex-row gap-4 justify-center\">
            <button className=\"px-8 py-4 bg-goldAccent text-midnight font-bold rounded-full hover:scale-105 transition-transform shadow-xl shadow-goldAccent/20\">
              View My Impact
            </button>
