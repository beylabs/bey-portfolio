      ...
      <div className="container mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
            ...
            <a href="/cv/SKhalidUmar_CV2026.pdf" download className="px-8 py-4 border border-goldAccent text-goldAccent rounded-full hover:bg-goldAccent hover:text-midnight transition-colors">
              Download CV
            </a>
          </div>
        </motion.div>
